...
public final class AuthProvider extends AbstractLdapAuthenticationProvider {
    ...
    AuthProvider.ContextFactory contextFactory = new AuthProvider.ContextFactory();

    public AuthProvider(String domain, String url, String rootDn) {
    ...
    public AuthProvider(String domain, String url) {
        Assert.isTrue(StringUtils.hasText(url), "Url cannot be empty");
        this.domain = StringUtils.hasText(domain) ? domain.toLowerCase() : null;
        this.url = url;
    ...
    private void raiseExceptionForErrorCode(int code, NamingException exception) {
        ...
        final class ActiveDirectoryAuthenticationException extends org.springframework.security.core.AuthenticationException {
