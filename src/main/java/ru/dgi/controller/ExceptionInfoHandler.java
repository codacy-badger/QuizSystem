...
import ru.dgi.util.ValidationUtil;
import ru.dgi.util.exception.ApplicationException;
import ru.dgi.util.exception.ErrorInfo;
import ru.dgi.util.exception.ErrorType;
...
import static ru.dgi.util.exception.ErrorType.APP_ERROR;
import static ru.dgi.util.exception.ErrorType.DATA_ERROR;
import static ru.dgi.util.exception.ErrorType.VALIDATION_ERROR;
...
public class ExceptionInfoHandler {
    ...
    public static final String EXCEPTION_ANSWER_EXISTS = "exception.quest.answer-exists";
    public static final String EXCEPTION_STARTS_ANSWERING = "exception.quest.starts-answering";

    private static final Map<String, String> CONSTRAINS_I18N_MAP = Collections.unmodifiableMap(
            new HashMap<String, String>() {
                {
                    put("constraint_answer_question_id", EXCEPTION_ANSWER_EXISTS);
                    put("constraint_results_quest_id", EXCEPTION_STARTS_ANSWERING);
                }
            });
